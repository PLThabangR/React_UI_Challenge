  ...
  return (
    <section className="header">
       <span className='primary-heading'> <Text  variant='p' style={{color:'white'}} >minim veniam, quis nostrud exercitation</Text></span>
        <span className='main-heading'>  <Text variant='h1'style={{color:'white'}}>Acs office dits book llove Is Lijch</Text></span>
        ...
        <button className='button-heading'>Header</button>
    </section>
  )
}
